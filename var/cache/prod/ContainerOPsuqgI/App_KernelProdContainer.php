...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yszPuHOUVJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['App\\Security\\Voter\\BlogPostVoter'] ?? $this->load('getBlogPostVoterService'));
    ...
    protected function getSecurity_FirewallService()
    {
        ...
        $b = new \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()));
        $b->registerListener('main', 'app_auth_logout', 'logout', '_csrf_token', NULL, NULL);

        return $this->privates['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(($this->privates['security.firewall.map'] ?? $this->getSecurity_Firewall_MapService()), $a, $b);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'redis_host' => $this->getEnv('key:host:url:REDIS_URL'),
            'redis_port' => $this->getEnv('key:port:url:REDIS_URL'),
